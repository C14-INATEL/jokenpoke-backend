...
class TestBuildDeckUseCase:
    def test_build_deck_mock_success(self):
        ...
        carta3.id = 103
        carta4 = MagicMock()
        carta4.pokemon_id = 25
        carta4.id = 104
        carta5 = MagicMock()
        carta5.pokemon_id = 133
        carta5.id = 105
    ...
    def test_build_deck_missing_pokemon_mock(self):
        ...
        carta_agua_1 = MagicMock()
        carta_agua_1.pokemon_id = 7
        carta_agua_2 = MagicMock()
        carta_agua_2.pokemon_id = 54
    ...
    def test_build_deck_user_not_found_mock(self):
        ...
        with pytest.raises(
            NotFoundException, match="Usuário com ID 999 não encontrado."
        ):
